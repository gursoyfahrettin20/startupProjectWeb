                ...
                <div className='col-lg-6 offset-lg-3 col-sm-8 offset-sm-2'>
                    ...
                    <div className='card-body'>
                        ...
                        <div className='mb-3'>
                            ...
                            <input id="username" className={errors.username ? 'form-control is-invalid' : 'form-control'} type="text" onChange={(event) => setUsername(event.target.value)} />
                        </div>
                        <div className='mb-3'>
                            <label className='form-label' htmlFor='email'> E-Mail </label>
                            <input id="email" className='form-control' type="text" onChange={(event) => setEmail(event.target.value)} />
                        </div>
                        <div className='mb-3'>
