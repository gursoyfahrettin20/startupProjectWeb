...
function index() {
    ...
    function customNotification(message, description, type, placement) {
        for (let i = 0; 0 < Object.keys(description).length; i++) {
            return () => {
                api[type]({
                    message: message,
                    description: description[Object.keys(description)[i]],
